...
ArticleAdapter.ItemAction{
    ...
    public static final String API_KEY = "9ed713b4bf2743bf8b494c4c5c54b58a";
 ...
 */
    ...
    private void initListener(){
        ...
        adapter.setOnItemClickListener(new Adapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                Log.d(TAG,"transition name: "+ ViewCompat.getTransitionName(imageView));
    ...
    @Override
    public void onClick(View view, Article itemArticle) {
        ImageView imageView = view.findViewById(R.id.img);
        Intent intent = new Intent(MainActivity.this, NewsDetailActivity.class);


        intent.putExtra("url", itemArticle.getUrl());
        intent.putExtra("title", itemArticle.getTitle());
        intent.putExtra("img",  itemArticle.getUrlToImage());
        intent.putExtra("date",  itemArticle.getPublishedAt());
        intent.putExtra("source",  itemArticle.getSource().getName());
        intent.putExtra("author",  itemArticle.getAuthor());
